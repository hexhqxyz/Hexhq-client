...
export const faucetErrors: Record<string, { title: string; description: (args: any) => string }> = {
    ClaimTooSoon: {
      title: "Claim Too Soon",
      description: (args) => `Please wait ${args[0].toString()} seconds before claiming again.`,
    },
